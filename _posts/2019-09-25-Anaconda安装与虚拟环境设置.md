...
临时使用：`pip install -i https://pypi.tuna.tsinghua.edu.cn/simple xxx`
...
激活该环境之后，即可使用 conda 安装所需的 python 包．
...
3. Conda的包安装方式
   ...
   - 激活环境之后，再使用conda install命令:

   ```
   conda install beautifulsoup4
   ````

4. 从Anaconda.org安装一个包
