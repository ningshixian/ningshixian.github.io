...
![img](https://img2020.cnblogs.com/other/1218593/202007/1218593-20200714150739594-1361995225.webp)

#### 安装nginx

nginx官网下载地址：[http://nginx.org](http://nginx.org/)，发布版本分为 Linux 和 windows 版本。
...
http {
  ...
  server {
       ...
       location / {
           ...
           proxy_pass  http://load\_balance\_server ;#请求转向load\_balance\_server 定义的服务器列表
           ...
           proxy\_busy\_buffers_size 64k;       #高负荷下缓冲大小（proxy_buffers*2）
...
web 领域开发中，经常采用前后端分离模式。这种模式下，前端和后端分别是独立的 web 应用程序，例如：后端是 Java 程序，前端是 React 或 Vue 应用，更多请看这篇文章《[到底什么是跨域，及解决方案](http://mp.weixin.qq.com/s?__biz=MzI3ODcxMzQzMw==&mid=2247485898&idx=1&sn=32626e4f241d5f04684736b52afafb10&chksm=eb538cfcdc2405ea368fa092c0af8e424ad843198274426cca275acc8ed83d86497ec3a54acc&scene=21#wechat_redirect)》。
...
# www.javastack.com 域名需配合 dns hosts 进行配置
...
https://www.cnblogs.com/javastack/p/13299177.html