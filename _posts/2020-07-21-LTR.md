...
1. Collect Training Data (Queries and their labeled documents)
2. Feature Extraction for Query-document Pairs
3. Learning the Ranking Model by Minimizing a Loss Function on the Training Data
4. Use the Model to Answer Online Queries
