...
1. Doc特征：Pagerank、质量特征、类别特征、文章长度、新鲜度、来源帖子、CTR、停留时长、点赞数
2. Query-Doc相关性特征：命中特征、query 和 doc 之间的词共现特性、査询词的Proximity值（即在文档中多大的窗口内可以出现所有査询词）、**bm25**、TF-IDF、vsm、BOW
3. Query特征：意图分类、关键词、词权重等
