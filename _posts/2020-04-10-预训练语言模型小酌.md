...
![](https://mmbiz.qpic.cn/mmbiz_jpg/bQX4ib2RuthApR9wb9SIQuKKsTguSLictqJ0ZJmrTAibib2cVgJNOxb5WEC0ZEV40MicMtYfUxMQQGnESFwW0Zib367w/640?wx_fmt=jpeg&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
- bert是在transformer encoder的基础之上进行改进的。使用了12个 *transformer encoder block*，在13G的数据上进行了预训练（大力出奇迹）；在embedding，multi-head attention，loss (Masked LMNext Sentence Prediction) 上有所差别。 
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/bQX4ib2RuthApR9wb9SIQuKKsTguSLictqf1FygyNBw3zNIYU64JjxQCribfCShzolZeewcDt1IoXDibVCGOxhwskA/640?wx_fmt=jpeg&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
xlnet使用了transformer-xl的框架，并在transformer的基础之上使用了双流自注意力机制。
 ...
 ![img](https://mmbiz.qpic.cn/mmbiz_jpg/bQX4ib2RuthApR9wb9SIQuKKsTguSLictqFicDOicUnjuMRUw7S7gVa66QP37VLicERNDaALaKx09XkvjgwNsuBqgrA/640?wx_fmt=jpeg&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
在xlnet使用126G的数据登顶GLUE之后不久，roberta使用==160G==的数据又打败了xlnet。roberta的创新点主要有4点：
